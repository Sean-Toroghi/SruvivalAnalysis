...
- [**Module 1 — Foundations**](#m_1): The core concepts: what survival analysis is, the censoring problem (and why it can't be ignored), the three key mathematical functions S(t), h(t), H(t), and how the likelihood is constructed with censored data. With interactive Weibull explorer to explore how different hazard shapes look.
- [**Module 2 — Non-parametric methods**](#m_2): Kaplan-Meier and Nelson-Aalen estimators, the log-rank test for group comparisons, and Python code using `lifelines`.
...
# <a name = 'm_2'>[Module 2 — Non-parametric methods](#up)</a>
